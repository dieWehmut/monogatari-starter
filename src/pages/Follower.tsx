    ...
    <div className="min-h-screen pb-28">
      <header className="fixed left-0 right-0 top-0 z-40 px-3 pt-3">
        <div className="mx-auto flex w-full max-w-3xl items-center justify-between">
          ...
          <div className="flex flex-col items-center">
            <span className="text-sm font-medium text-[var(--text-main)]">{t('social.followersTitle')}</span>
      ...
      <main className="mx-auto w-full max-w-3xl px-4 pt-20">
        ...
        {!authAllowed ? (
          ...
          <p className="mt-10 text-center text-sm text-soft">{t('social.noFollowers')}</p>
        ) : (
